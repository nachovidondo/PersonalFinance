...
label_Supermercado.place(x=150, y = 400)
...
label_Servicios.place(x=150, y = 450)
...
label_TarjetaCredito.place(x=450, y = 300)
...
label_Transporte.place(x=450, y = 350)
...
label_ObraSocial.place(x=450, y = 400)
...
label_Recreativos.place(x=450, y = 450)
...
botonBorrarIngresos.place(x=400, y= 230 )
...
Mostrarmenu.add_command(label="Abrir Ingresos")
Mostrarmenu.add_separator()


Mostrarmenu.add_command(label="Abrir Gastos")
Mostrarmenu.add_separator()
